...
function printHeader($pagina = 'default', $login)
{
    ...
    switch ($pagina) {
        case "cerca":
            ...
            $header = str_replace('<a href="./index.php" class="logo"><abbr lang=" en" title="Books Tutoring Notes">BTN</abbr></a>', '<abbr lang=" en" title="Books Tutoring Notes">BTN</abbr>', $header);
            break;
        case "info":
