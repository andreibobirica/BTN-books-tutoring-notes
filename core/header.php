...
function printHeader($pagina, $login)
{
    ...
    switch ($pagina) {
        case "cerca":
            ...
            $header = str_replace('<a href="./index.php" class="logo"><abbr title="Book Tutoring Notes">BTN</abbr></a>', '<abbr title="Book Tutoring Notes">BTN</abbr>', $header);
            break;
        case "info":
...
function printBreadcrumb($pagina, $annuncio = 0)
{
    ...
    switch ($pagina) {
        ...
        case "new_listing":
            $breadcrumb .= '<li><a href="./index.php" lang="en">Home</a></li>';
            $breadcrumb .= '<li><a href="./area_riservata.php" lang="en">Area Riservata</a></li>';
            $breadcrumb .= '<li>Nuovo annuncio</li>';
            break;
        case "edit_listing":
            $breadcrumb .= '<li><a href="./index.php" lang="en">Home</a></li>';
            $breadcrumb .= '<li><a href="./area_riservata.php" lang="en">Area Riservata</a></li>';
